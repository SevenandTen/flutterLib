    ...
    List<Widget> list = [];
      ...
      for(int i = 0 ; i < 4 ; i ++) {
        ...
        if(step == 0) {
          for(int j = 0 ; j < 9 ; j ++) {
            int location = i * 9 + j ;
            if(location < WYCarNumberPicker.provinceList.length) {
              String char = WYCarNumberPicker.provinceList[location];
              subList.add(WYCarNumberInputItemView(
                width: someWidth,
                height: someHeight,
                inputType: 1,
                unable:WYCarNumberPicker.noSupportProvinceList.contains(char),
                char: char,
                callBack: () {
                  if(callBack != null) {
                    callBack!(char);
            ...
            }else if(location == WYCarNumberPicker.provinceList.length) {
          ...
          for(int j = 0 ; j < 10 ; j ++) {
            int location = i * 10 + j ;
            if(location < WYCarNumberPicker.charList.length) {
              String char = WYCarNumberPicker.charList[location];
              subList.add(WYCarNumberInputItemView(
                width: someWidth,
                height: someHeight,
                inputType: 2,
            ...
            }else if(location == WYCarNumberPicker.charList.length) {
              subList.add(WYCarNumberInputItemView(
                width: someWidth * 2 + 6,
                height: someHeight,
                inputType: 2,
